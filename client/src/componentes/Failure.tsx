    ...
    return (
      ...
      <Header/>
        <div className="w-full flex flex-col items-center h-screen">
            ...
            <img src={henryFull} className="w-64 xl:w-96" alt="logoHenry" />
            <h2 className="text-xl xl:text-4xl mt-2">Lo sentimos, no se pudo proceder con la compra.</h2>
             <h3 className="text-xl xl:text-3xl p-2">¡Intentelo de nuevo más tarde!</h3>
            <Link to="/">
