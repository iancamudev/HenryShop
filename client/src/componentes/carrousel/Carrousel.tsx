  ...
  return width < 800 ? (
    ...
    <div className="flex flex-col bg-gray-800 w-full h-auto justify-center items-center">
      <div className="flex flex-row justify-center items-center  pb-4 pt-6">
        <button
          onClick={prevImg}
          className="absolute mr-[500px] bg-yellow rounded-full items-center p-2 border-b-2 border-solid border-black duration-300 hover:duration-300 cursor-pointer hover:bg-gray-400 "
        >
          <MdArrowBackIosNew className="w-6 h-6" />
        </button>
        {bestProducts?.map((e: any, index: any) => {
            ...
            >
              {currentImg === index && (
                ...
                >
                  ...
                  <div className="flex flex-row items-center justify-start px-5 bg-white h-64 rounded-3xl mt-4 p-2 hover:bg-gray-400 duration-300 hover:duration-300 cursor-pointer w-[500px]">
                    <Link to={`/products/${e.product.id}`}>
                      <img
                        key={index}
                        className="w-56"
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <p className="mb-4 items-center text-black font-bold text-left">
                        {e.product.name}
                      </p>
                    </div>
                  </div>
        ...
        <button
          onClick={nextImg}
          className="absolute ml-[500px] bg-yellow rounded-full items-center p-2 border-b-2 border-solid border-black duration-300 hover:duration-300 cursor-pointer hover:bg-gray-400 "
        >
          <MdArrowBackIosNew className="rotate-180 w-6 h-6" />
        </button>
      </div>
