  ...
  if(window.screen.width > 390){
    return (
        <div className="py-5 w-full">
            <div className="h-32 bg-yellow max-[600px]:bg-sky-300 flex justify-between items-center">
            <div className="pl-10 text-5xl text-left font-bold">CLUB<p>HENRY</p>
            </div>
            <p className="pl-10 pr-3 text-left">¿Deseas conocer más de nosotros, ser el primero en enterarse de nuestros nuevos productos, promociones y mucho más? Déjanos tu e-mail...
                 </p>      
            <div className="pr-10 ml-2"><NewsLetter /></div>
          </div>
    ...
    <footer className="text-center bg-slate-900 text-white xl:w-screen">
            <div className="flex flex-col items-center">
                ...
                <div className="mr-3 ml-0 mt-2 w-2/5 h-5 border-t border-white"></div>
                    ...
                    <div className="ml-3 mr-0 mt-2 w-2/5 h-5 border-t border-white"></div></div>
                    <div>
                        <form action="">
                    ...
                    <div className="mb-6">
                        <p>
                            ¿Deseas conocer más de nosotros? sé el primero en enterarte de nuestras novedades y
                ...
                <div className="text-center p-4">
                    © 2022 Copyright:
                    <a className="text-white" href="http://localhost:3000/"> HenryShop</a>
                </div>
            </div>
        </footer>
  )
