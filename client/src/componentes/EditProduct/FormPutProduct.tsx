...
const FormPutProduct = () => {
  ...
  const submitForm = async ({ name, description, price, image }: formData) => {
  ...
  return Product && Product.price.at(-1) !== undefined ? (
    <form
...
function async(arg0: ({ name, description, price, image }: formData) => void) {
