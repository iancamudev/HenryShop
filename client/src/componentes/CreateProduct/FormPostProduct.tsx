...
const schema = yup.object({
    ...
    rating: yup.number().typeError("El rating debe ser un número").min(0, 'el número debe ser mayor o igual a 0').max(5, 'el número debe ser menor o igual a 5').nullable().transform((v, o) => o === '' ? null : v),
    ...
    price: yup.number().typeError("El precio debe ser un número").min(0, 'requiere un precio igual o superior a 0').required("No olvides agregar el precio del prodcuto"),
    ...
    colors: yup.array().of(yup.string().oneOf(Object.values(colors))).nullable(),
    ...
    return (
        ...
        >
            <div className="mb-3.5 w-full">
                <div className="flex justify-center"><input {...register('name')} id="name" type="text" placeholder="Name..." className="border border-black border-solid w-full rounded-2xl pl-2 py-1" />*</div>
                {errors?.name && (
