...
const ProductSlice = createSlice({
  ...
  reducers: {
    ...
    getBestRankList(state, action: PayloadAction<Array<Object>>) {
...
export const { getProductList, getProductPages, getProductDetail, setLoading, setError, clearProductLsit, getBestRankList } =
